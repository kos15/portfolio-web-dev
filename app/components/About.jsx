        ...
        <div id='about' className='w-full px-[12%] py-10 scroll-mt-20'>
            ...
            <div className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
                ...
                <div className='flex-1'>
                    ...
                    <ul className='grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2x]'>
                        {infoList.map(({ icon, iconDark, title, description }, index) => {
                            return <li className='border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover:bg-amber-100 hover:-translate-y-2 duration-500 hover:shadow-[4px_4px_0px_rgba(0,0,0,1)]' key={index}>
                                <Image src={icon} height={icon?.height} width={icon?.width} alt={title} className='w-7mt-3' />
