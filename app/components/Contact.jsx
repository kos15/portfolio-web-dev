...
function Contact({ isDarkMode }) {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "eeb56b74-883a-4f55-a2d1-2306f950b091");
  ...
  return (
    <motion.div
      ...
      onSubmit={onSubmit} className='mx-w-2xl mx-auto'>
        <div className='grid grid-cols-[repeat(auto-fit,_minmax(200px,_1fr))] gap-6 mt-10 mb-8'>
          ...
          type="email" placeholder='Enter your email' required className='flex-1 p-3 outline-none border-[0.5px] border-gray-400 rounded-md bg-white dark:bg-[#2a004a]/30 dark:border-white/90'
            name='email' />
        </div>
