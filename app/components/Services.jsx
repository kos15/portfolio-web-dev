        ...
        <div id='service' className='w-full px-[12%] py-10 scroll-mt-20'>
            ...
            <div className='grid grid-cols-auto gap-6 my-10'>
                {serviceData.map(({ icon, title, description, link }, index) => (
                    <div key={index}
                    className= 'border border-gray-400 rounded-1g px-8 py-12 hover: shadow-black cursor-pointer hover:-translate-y-2 duration-500 hover:shadow-[4px_4px_0px_rgba(0,0,0,1)] hover:bg-amber-100'>
