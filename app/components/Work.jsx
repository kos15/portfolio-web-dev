    ...
    return (
        <motion.div
            ...
            <motion.p
                ...
                className='text-center max-w-2x1 mx-auto mt-5 mb-12 font-Ovo'>Welcome to my web development portfolio! Explore a collection of projects
            ...
            <motion.a
                ...
                transition={{ duration: 0.6, delay: 1.2 }} href="" className='w-max flex items-center justify-center gap-2 text-gray-700 border-[0.5px]  border-gray-700 rounded-full py-3 px-10 mx-auto my-20 hover:bg-lightHover duration-500 dark:text-white
            dark:hover:bg-[#2a004a] dark:border-white'>
